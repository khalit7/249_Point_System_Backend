...
def bookView(request):
    ...
    if serializer.is_valid():
        ...
        try:
            resource = Resource.objects.get(id= request.data['resource'])
            serializer.save(customer=customer,resource=resource)
            data['resource'] = ResourceSerializer(resource).data
